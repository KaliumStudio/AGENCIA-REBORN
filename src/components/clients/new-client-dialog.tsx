...
export function NewClientDialog({ onClientCreated }: NewClientDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await clientService.createClient({ ...formData, createdBy: profile.uid });
      ...
      <DialogContent className="sm:max-w-[425px] p-0">
        <div className="p-6 overflow-y-auto max-h-[90dvh]">
          <DialogHeader className="mb-6">
            ...
            <DialogDescription>Agrega los datos de la empresa para habilitar su acceso al portal.</DialogDescription>
          </DialogHeader>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="contact" required placeholder="Nombre del responsable" className="h-11" value={formData.contact} onChange={e => setFormData({...formData, contact: e.target.value})} />
            </div>
            <div className="space-y-2">
