...
import { Send, ArrowLeft, RefreshCw, Sparkles, CheckCircle2, Loader2, Menu } from 'lucide-react';
      ...
      <DashboardLayout>
        <div className="flex flex-col lg:flex-row h-[calc(100dvh-12rem)] gap-6 relative">
          <div className="flex-1 flex flex-col bg-white rounded-xl shadow-sm border overflow-hidden">
            ...
            <form onSubmit={handleSend} className="p-3 md:p-4 border-t bg-white flex gap-2 sticky bottom-0">
              <Input 
                placeholder="Escribe un mensaje..." 
                value={newMessage} 
                onChange={e => setNewMessage(e.target.value)}
                className="rounded-full px-6 h-11 md:h-12 border-muted-foreground/20 focus-visible:ring-primary"
              />
